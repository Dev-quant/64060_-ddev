...
Cluster-1:
```{r}
kable(pharma.norm.df[c(6,8,12),],align = "c")
```
...
Cluster-2:
```{r}
kable(pharma.norm.df[c(2,18),],align = "c")
```
...
Cluster-3:
```{r}
kable(pharma.norm.df[c(1,3,4,7,10,16,19,21),],align = "c")
```
...
Cluster-4:
```{r}
kable(pharma.norm.df[c(11,17,15,13),],align = "c")
```
...
Cluster-5:
```{r}
kable(pharma.norm.df[c(5,9,14,20),],align = "c")
```
